...
export type PostViewWhereInput = {
  ...
  viewerHash?: Prisma.StringFilter<"PostView"> | string
  day?: Prisma.StringFilter<"PostView"> | string
...
export type PostViewWhereUniqueInput = Prisma.AtLeast<{
  postId_viewerHash_day?: Prisma.PostViewPostIdViewerHashDayCompoundUniqueInput
  AND?: Prisma.PostViewWhereInput | Prisma.PostViewWhereInput[]
  OR?: Prisma.PostViewWhereInput[]
  NOT?: Prisma.PostViewWhereInput | Prisma.PostViewWhereInput[]
  postId?: Prisma.StringFilter<"PostView"> | string
...
export type PostViewScalarWhereWithAggregatesInput = {
  ...
  viewerHash?: Prisma.StringWithAggregatesFilter<"PostView"> | string
  day?: Prisma.StringWithAggregatesFilter<"PostView"> | string
...
export type PostViewPostIdViewerHashDayCompoundUniqueInput = {
  postId: string
  viewerHash: string
  day: string
}
...
export type PostViewOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"postId" | "viewerHash" | "day" | "createdAt", ExtArgs["result"]["postView"]>
...
export interface PostViewDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many PostViews and only return the `postId`
   * const postViewWithPostIdOnly = await prisma.postView.createManyAndReturn({
   *   select: { postId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more PostViews and only return the `postId`
   * const postViewWithPostIdOnly = await prisma.postView.updateManyAndReturn({
   *   select: { postId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface PostViewFieldRefs {
  ...
  readonly viewerHash: Prisma.FieldRef<"PostView", 'String'>
  readonly day: Prisma.FieldRef<"PostView", 'String'>
